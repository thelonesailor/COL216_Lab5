...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-7888-Prakhar-PC/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog D:/4thSemester/COL216/Labs/Lab5/project_1/project_1.srcs/sources_1/imports/tb_release/arm_golden.v
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-7888-Prakhar-PC/"
    if {$rt::useElabCache == false} {
